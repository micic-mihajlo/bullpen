      ...
      <div className="flex-1 flex min-h-0 overflow-hidden">
              ...
              {pendingReview.map((d) => (
                ...
                >
                  <div onClick={() => setSelectedId(d._id)} className="mb-2">
                    ...
                    <div className="text-[10px] text-mc-muted mt-1 font-mono-jb">
                  ...
                  {!selectedId && (
                    <div className="flex gap-2 mt-2">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 px-2.5 py-1 text-xs text-mc-accent-green bg-mc-accent-green/8 hover:bg-mc-accent-green/15 rounded transition-colors disabled:opacity-50 font-medium"
                      >
                      ...
                      <button
                        ...
                        disabled={processing === d._id}
                        className="flex items-center gap-1 px-2.5 py-1 text-xs text-mc-accent-red bg-mc-accent-red/8 hover:bg-mc-accent-red/15 rounded transition-colors disabled:opacity-50 font-medium"
                      >
        ...
        {selectedId && selectedDeliverable && (
          <div className="flex-1 flex flex-col overflow-hidden animate-slide-in-left">
            <div className="px-6 py-3 border-b border-mc-border flex items-center justify-between flex-shrink-0 bg-mc-bg-secondary/80">
              <div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-mc-accent-green text-white rounded hover:bg-mc-accent-green/90 transition-colors disabled:opacity-50 font-mono-jb uppercase tracking-wide"
                >
                ...
                <button
                  ...
                  disabled={processing === selectedDeliverable._id}
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-mc-accent-red text-white rounded hover:bg-mc-accent-red/90 transition-colors disabled:opacity-50 font-mono-jb uppercase tracking-wide"
                >
            ...
            <div className="flex-1 overflow-y-auto p-6">
              <div className="prose-warm max-w-none">
                {selectedDeliverable.format === "code" ? (
                  <pre className="p-4 bg-mc-bg-tertiary rounded border border-mc-border text-sm overflow-x-auto whitespace-pre-wrap break-words font-mono-jb text-mc-text">
