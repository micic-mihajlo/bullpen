        ...
        {selectedId && selectedDeliverable && (
          <div className="flex-1 flex flex-col overflow-hidden animate-slide-in-left">
            <div className="px-6 py-3 border-b border-mc-border flex items-center justify-between flex-shrink-0">
              <div>
                <h2 className="text-sm font-semibold">{selectedDeliverable.title}</h2>
                <div className="text-xs text-mc-text-secondary">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-mc-accent-green/15 text-mc-accent-green rounded hover:bg-mc-accent-green/25 transition-colors disabled:opacity-50"
                >
                ...
                <button
                  ...
                  disabled={processing === selectedDeliverable._id}
                  className="flex items-center gap-1.5 px-3 py-1.5 text-xs bg-mc-accent-red/15 text-mc-accent-red rounded hover:bg-mc-accent-red/25 transition-colors disabled:opacity-50"
                >
